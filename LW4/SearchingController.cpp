...
namespace LW4
{
	namespace Controllers
	{
		namespace Data
		{
			...
			SearchingController::SearchingController(const SearchingController& other)
			{
			...
			SearchingController& SearchingController::operator =(const SearchingController& other)
			{
				if (this == &other)
					return *this;
